...
$$
\underbrace{\sum_{i \in L}(y_i-\overline{y}_L)^2}_{\text{left-side MSE}} + \underbrace{\sum_{i \in R}(y_i-\overline{y}_R)^2}_{\text{right-side MSE}}
$$

3. Repeat this process.

4. Our prediction within each leaf is the sample mean within each leaf:
...
$$
\hat{\mu}(x;S^{est},\pi(S^{tr}))=\frac{1}{\#(i \in S^{est} : X_i \in \textit{l}(x;\pi(S^{tr})))}\sum\limits_{i\in S^{est}:X_i \in \textit{l}(x;\pi(S^{tr}))}Y_i
$$
...
\begin{align*}
    ...
    \quad \{ \{L\}, \{R \} \} & \text{ifx} \quad \bar{Y}_L -\bar{Y}_R > c
    \end{cases}
\end{align*}
...
\begin{align*}
        \text{MSE}_{\mu}(\underbrace{S^{te}}_\text{test set},\underbrace{S^{est}}_\text{estimation set},\Pi) &= \frac{1}{\#(S^{te})}\sum\limits_{i \in S^{te}}\left[(Y_i - \hat{\mu}(X_i;S^{\color{red} est},\Pi))^2{\color{blue} -Y_i^2}\right]
\end{align*}
...
\begin{align*}
        \text{MSE}_{\tau}(\mathcal{S^{{\color{red}\text{te}}}},\mathcal{S^{{\color{red}\text{est}}}}) &\equiv \frac{1}{\text{N}^{\color{red}\text{te}}}\sum_{i\in \mathcal{S^{{\color{red}\text{te}}}}}[(\tau_i-\hat{\tau}(X_i;\mathcal{S^{{\color{red}\text{est}}}},\Pi))^2 -\tau_i^2 ]\notag \\
        &= \frac{1}{\text{N}^{\color{red}\text{te}}}\sum_{i\in \mathcal{S^{{\color{red}\text{te}}}}}[-2\tau_i\cdot \hat{\tau}(X_i;\mathcal{S^{{\color{red}\text{est}}}},\Pi)+\hat{\tau}^2 (X_i;\mathcal{S^{{\color{red}\text{est}}}},\Pi)] \\
        EMSE &=\mathbb{E}_{\mathcal{S}^{\color{red}{te}}, \mathcal{S}^{\color{red}{est}}}[\sum_{i\in \mathcal{S}^{\color{red}{te}}}((\tau_i-\hat{\tau}(X_i;\mathcal{S}^{\color{red}est}))^2-\tau_i^2)] \\
        &= \mathbb{V}_{\mathcal{S}^{\text{est}}, X_i}[\hat{\tau}(X_i; \mathcal{S}^{\text{est}},\Pi)]-\mathbb{E}_{X_i}[\tau^2(X_i;\Pi)]
\end{align*}
