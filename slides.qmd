...
- To build Regression tree, we compare
    ...
    \begin{equation*}
    \begin{aligned}
        \frac{1}{\#(S^{tr})}\sum\limits_{i: X_i \in S^{tr}}(Y_i-\bar{Y})^2 \quad\text{and}\qquad \qquad \qquad \qquad \qquad \qquad \qquad  \\
         \frac{1}{\#(i:X_i\in L)}\sum\limits_{i: X_i=L}(Y_i-\bar{Y_L})^2+\frac{1}{\#(i: X_i \in R)}\sum\limits_{i:X_i = R}(Y_i-\bar{Y_R})^2
     \end{aligned}
    \end{equation*}
...
- <a href="/ref/athey_and_imbens_2016(proof).pdf" class="btn btn-primary">Proofs and Detailed Explanation of the Paper</a>  - oriented by Wooyong Park and Jeongwoo Yang
...
- <a href="https://wooyongp.github.io/rpart-jsc25_1/ref/honest_practice.html" class="btn btn-primary">Examples of Applied Micro papers using the causal tree + generalized random forests</a>  - oriented by Minseo Seok
